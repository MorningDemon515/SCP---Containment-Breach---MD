		...
		Select MainMenuTab
			...
			Case 3,5,6,7 ;options
				...
				ElseIf MainMenuTab = 7 ;Advanced
					...
					;Color 255,255,255
					;Text(x + 20 * MenuScale, y, "Antialiased text:")
					;TextEnable% = DrawTick(x + 310 * MenuScale, y + MenuScale, TextEnable%)
...
Function UpdateLauncher()
	...
	AppTitle "SCP - Containment Breach MD Launcher"
	...
	Repeat
		...
		If (Not BorderlessWindowed)
			If Fullscreen
				Text(40+ 260 + 15 + 8, 262 - 55 + 140, "Current Resolution: "+(GfxModeWidths(SelectedGFXMode) + "x" + GfxModeHeights(SelectedGFXMode) + "," + (16+(16*(Not Bit16Mode)))))
			Else
				Text(40+ 260 + 15 + 8, 262 - 55 + 140, "Current Resolution: "+(GfxModeWidths(SelectedGFXMode) + "x" + GfxModeHeights(SelectedGFXMode) + ",32"))
			EndIf
		Else
			Text(40+ 260 + 15 +8, 262 - 55 + 140, "Current Resolution: "+GfxModeWidths(SelectedGFXMode) + "x" + GfxModeHeights(SelectedGFXMode) + ",32")
