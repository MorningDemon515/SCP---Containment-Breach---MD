...
Font1% = LoadFont("GFX\font\cour\Morning Demon.ttf", Int(16 * (GraphicHeight / 1024.0)))
Font2% = LoadFont("GFX\font\cour\Morning Demon.ttf", Int(55 * (GraphicHeight / 1024.0)))
...
ConsoleFont% = LoadFont("GFX\font\cour\Morning Demon.ttf", Int(17 * (GraphicHeight / 1024.0)))
...
Function CatchErrors(location$)
    InitErrorMsgs(6)
	SetErrorMsg(0, "An error occured in SCP - Containment Breach MD v" + VersionNumber)
...
Function PlayStartupVideos()
	...
	For i = 0 To 3
		Select i
			...
			Case 3
				;[Block]
				MovieFile = "GFX\menu\startup_SCP"
				;[End Block]	
		End Select
